---
{"dg-publish":true,"permalink":"/_Documents/文献集/","noteIcon":"default","created":"2025-07-31T13:43:21.487+08:00","updated":"2025-10-16T17:39:59.516+08:00"}
---
...
## 2.1 Compressive Coherent Structures at Ion Scales in The Slow Solar Wind (have read)   
### 2.1.1 论文  
...
i = x,y,z,\perp,\| 
$$
此处 $j$ 是尺度 $\tau$ 的索引，$\delta j$ 是尺度的常数步长，$\psi_0(0)=\pi^{1/4},~ C_\delta =0.776$（可见[[_Documents/docs/2.2 A Practical Guide to Wavelet Analysis.pdf|小波教程_en]]），采取 $\tau(j_1)=0.5s,~\tau(j_2)=10s$.  
...
## 2.2 A Practical Guide to Wavelet Analysis (read partially)  
### 2.2.1 论文  
A Practical Guide to Wavelet Analysis.  
### 2.2.2 主要内容  
### 2.2.3 链接
本地 [[_Documents/docs/2.2 A Practical Guide to Wavelet Analysis.pdf|2.2 A Practical Guide to Wavelet Analysis]]
### 2.2.4 补充

## 2.3 Coherent Structures at Ion Scales in Fast Solar Wind: Cluster Observations  
### 2.3.1 论文  
Perrone, D., Alexandrava, O., Roberts, O. W., Lion, S., Lacombe, C., Walsh, A., Maksimovic, M., & Zouganelis, I. (2017). Coherent structures at ion scales in fast solar wind: Cluster observations. _The Astrophysical Journal , 849_(1), 49. https://doi.org/10.3847/1538-4357/aa9022

### 2.3.2 主要内容  
### 2.3.3 链接
本地 [[_Documents/docs/2.3 Perrone et al_2017_Coherent Structures at Ion Scales in Fast Solar Wind.pdf|2.3 Perrone et al_2017_Coherent Structures at Ion Scales in Fast Solar Wind]]
### 2.3.4 补充
