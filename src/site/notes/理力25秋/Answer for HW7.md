...
## 2.1 三维各向同性谐振子  
#### (a)  
将 $m\omega^2$ 替换为 $k$，$m$ 替换为约化质量 $\mu$，可得到与 [[#(a) 线性力 $ vec{F}=-k vec{r}$, $U= frac{1}{2}kr 2$|HW7-1第三题(a)]] 一致的结果。题目要求用积分求解，助教在这里偷个懒，就不细算了。
...
## 2.2 势散射  
#### (a)  
与 [[#(a)|HW7-1第2题(a)]] 同理，不赘述。  
#### (b) (c)
题目中的碰撞参数 $b$ 是瞄准距离，此题与 [[#(b)|HW7-1第2题(b)]] 相同，两者的结果分别是 [[#(b)|HW7-1第2题(b)]] 的(5)式和(6)式。
## 2.3 $r^{-2}$ 势散射
#### 2.3 (a)  
