---
{"dg-publish":true,"permalink":"/C++/2. C++面向对象编程入门/","noteIcon":"","created":"2025-08-24T23:01:59.987+08:00","updated":"2025-09-12T21:51:04.562+08:00"}
---
...
class Derived : public Base{
	public:
		Derived(int bb, int dd) : Base(bb), d(dd) { cout << "派生类的构造函数被调用！" << endl; }
		~Derived() { cout << "派生类的析构函数被调用！" << endl; }
	protected:
		int d;
};
