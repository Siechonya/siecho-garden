---
{"dg-publish":true,"permalink":"/C++/1. C++基础/","noteIcon":"default","created":"2024-10-27T18:33:52.711+08:00","updated":"2025-11-24T15:33:32.937+08:00","dg-note-properties":{}}
---
...
其他强制转换类型的函数:  [[C++/1. C++基础#6.1 pointer(指针)\|const_cast]], [[C++/3. C++面向对象编程(OOP)进阶#2.5 dynamic_cast\|dynamic_cast]], reinterpret_cast
## 3.4 注释与换行
```c++
//双斜线表示单行注释
...
## 5.5 struct (结构体)  
## 5.6 class (类)  
见 [[C++/2. C++面向对象编程(OOP)入门#1 类和继承\|C++面向对象编程]].
# 6 Derived (派生数据类型)
## 6.1 pointer(指针)
```c++
//definition ex.
