---
{"dg-publish":true,"permalink":"/C++/3. C++面向对象编程(OOP)进阶/","noteIcon":"default","created":"2025-09-12T21:51:15.680+08:00","updated":"2025-09-19T22:26:22.814+08:00","dg-note-properties":{}}
---
...
```
# 3 Overloading (操作符重载)  
在 [[C++/3. C++面向对象编程(OOP)进阶#1.3 Overload assignment (重载赋值操作符)\|#1.3 Overload assignment (重载赋值操作符)]] 已经介绍过一部分有关操作符重载的内容。
## 3.1 一般语法  
几个注意点：  
- 形参的数目和操作符操作数的数目相同；
