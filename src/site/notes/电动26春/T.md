---
{"dg-publish":true,"permalink":"/电动26春/T/","noteIcon":"default","created":"2026-06-15T09:48:59.284+08:00","updated":"2026-04-06T15:21:00.012+08:00","dg-note-properties":{}}
---
...
1. 封闭性（乘法）：
    ...
    - 对于性质 $\Lambda^0{}_0 \ge 1$，两个正规变换的乘积依然是正规的（这可以通过柯西-施瓦茨不等式证明，见后续 [[电动26春/T#3.5.3 若 $ Lambda_1, Lambda_2$ 满足 $( Lambda_1) 0_0 ge 1$ 且 $( Lambda_2) 0_0 ge 1$，则它们的乘积 $ Lambda = Lambda_1 Lambda_2$ 的分量 $ Lambda 0_0$ 也必然满足 $ Lambda 0_0 ge 1$。\|#3.5.3 若 $ Lambda_1, Lambda_2$ 满足 $( Lambda_1) 0_0 ge 1$ 且 $( Lambda_2) 0_0 ge 1$，则它们的乘积 $ Lambda = Lambda_1 Lambda_2$ 的分量 $ Lambda 0_0$ 也必然满足 $ Lambda 0_0 ge 1$。]]）。
    - 因此，乘积依然属于该子集。
2. 逆元存在性：
