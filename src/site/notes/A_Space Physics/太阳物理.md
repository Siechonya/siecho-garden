---
{"dg-publish":true,"permalink":"/A_Space Physics/太阳物理/","noteIcon":"default","created":"2025-10-23T14:26:26.840+08:00","updated":"2025-11-01T11:56:37.574+08:00"}
---
...
![[zz_figure/Pasted image 20250618135121.png#pic_center|475]]  
- 较差自转的物理图像
![[zz_figure/Pasted image 20250618141156.png#pic_center|550]]
## 2.2 太阳对流  
- 观测现象: (超)米粒组织
- 物理机制: 对流不稳定性
...
![[zz_figure/Pasted image 20250618160455.png#pic_center]]  
...
# 3 CH.3 太阳光球及其模型  
## 3.1 基本定义  
![[zz_figure/Pasted image 20250618170004.png#pic_center]]
- 辐射强度:  
$$
...
$$
- 光球中的辐射转移方程
![[zz_figure/Pasted image 20250618190030.png#pic_center]]
...
![[zz_figure/Pasted image 20250618215721.png#pic_center]]
## 4.1 针状体和色球网络
...
![[zz_figure/Pasted image 20250618215230.png#pic_center|600]]
上图中, 从线翼往线心, 辐射的来源高度越来越高, $K_1$ 形成于极小温度层, $K_2$ 形成于色球层温度上升区, $K_3$ 形成于更高层(密度很低, 已不满足“局部热动平衡”假设)。  
## 4.2 日冕辐射  
![[zz_figure/Pasted image 20250618220914.png#pic_center|294]]
- 主要成分
	- 白光日冕(散射日冕)
...
![[zz_figure/Pasted image 20250619203713.png#pic_center|525]]  
...
$$
-  磁浮力不稳定性图示 ![[zz_figure/Pasted image 20250619114505.png#pic_center|625]]  
- 衰减: 
	- 磁流管缩回到光球下面
	- 抛射到行星际空间
	- 磁能转化为热能和物质运动动能而耗散掉
...
- Hale极性定律(Hale 周期: 太阳磁场周期, 为 22 a)
	- Hale 极性定律图示 ![[zz_figure/Pasted image 20250619121042.png#pic_center|163]]
...
![[zz_figure/Pasted image 20250619133219.png#pic_center|312]]
注意日珥在上图轴线上, 即位于光球磁中性线上方.
##### 反常极性(K-R 模型)(二维) Kuperus-Roadu  
支撑日珥磁场的方向和由势场模型得到的方向相反  
![[zz_figure/Pasted image 20250619133751.png#pic_center|525]]
##### 通量管模型(三维)  
![[zz_figure/Pasted image 20250619134215.png#pic_center|332]]
##### 三维磁拱模型中性线上方的磁场是高度
...
##### 磁通量浮现模型  
单环耀斑图例:
![[zz_figure/Pasted image 20250619162820.png#pic_centter|425]]  
##### 倒 Y 型磁场模型  
双带耀斑图例:
![[zz_figure/Pasted image 20250619163122.png#pic_center|475]]  
...
![[zz_figure/Pasted image 20250619163322.png#pic_center|500]]
##### <font color="#ff0000">“标准模型”(CSHKP 模型)  (形成双带耀斑或耀斑爆发)</font>
![[zz_figure/Pasted image 20250619161905.png#pic_center|375]]
...
### 5.6.1 典型三分量结构  
白光日冕仪中 CME 的典型三分量结构:
![[zz_figure/Pasted image 20250619173346.png#pic_center|428]]  
...
![[zz_figure/Pasted image 20250619175127.png#pic_center|450]]  
- 粒子加速
![[zz_figure/Pasted image 20250619175220.png#pic_center|550]]
### 5.6.3 理想化的 CME 爆发伴随双带耀斑的<font color="#ff0000">物理模型</font>  
![[zz_figure/Pasted image 20250619175923.png#pic_center|750]]
### 5.6.4 CME 的触发机制  
...
- 磁缰截断(Tether cutting): 强剪切磁拱在腿部的磁重联触发CME爆发。在AB和CD腿部交叉的“$\times$”处触发磁重联, 使暗条失去平衡而上升, 暗条上升拉出电流片。电流片的重联导致暗条的加速抛射及双带耀斑产生。
	![[zz_figure/Pasted image 20250619195910.png#pic_center|575]]
##### 爆发成功的关键  
